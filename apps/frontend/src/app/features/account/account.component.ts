          ...
          <div class="card-body">
            ...
            <form (ngSubmit)="onSubmit()">
              <div class="form-control">
                ...
                <input type="text" id="fullName" placeholder="John Doe" class="input input-bordered" />
              </div>
              ...
              <div class="form-control mt-4">
                ...
                <input type="email" id="email" placeholder="john&#64;example.com" class="input input-bordered" />
              </div>
              ...
              <div class="form-control mt-4">
                ...
                <input type="tel" id="phone" placeholder="+1234567890" class="input input-bordered" />
              </div>
              ...
              <div class="border-b pb-6">
                ...
                <form (ngSubmit)="onChangePassword()">
                  <div class="form-control">
                    ...
                    <input type="password" id="currentPassword" class="input input-bordered" />
                  </div>
                  ...
                  <div class="form-control mt-4">
                    ...
                    <input type="password" id="confirmNewPassword" class="input input-bordered" />
                  </div>
