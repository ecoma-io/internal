...
> **start**(): `Promise`\<[`StartedMaildevContainer`](/libraries/common-testing/Class.StartedMaildevContainer.md)\>

#### Returns

`Promise`\<[`StartedMaildevContainer`](/libraries/common-testing/Class.StartedMaildevContainer.md)\>
