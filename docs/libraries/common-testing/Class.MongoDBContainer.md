...
> **new MongoDBContainer**(`image`): `MongoDBContainer`
...
> `protected` **containerStarted**(`startedTestContainer`): `Promise`\<`void`\>
...
> **start**(): `Promise`\<[`StartedMongoDBContainer`](/libraries/common-testing/Class.StartedMongoDBContainer.md)\>

#### Returns

`Promise`\<[`StartedMongoDBContainer`](/libraries/common-testing/Class.StartedMongoDBContainer.md)\>
