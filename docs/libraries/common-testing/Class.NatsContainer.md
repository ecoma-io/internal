...
> **new NatsContainer**(`image`): `NatsContainer`

#### Parameters

##### image

`string` = `"nats:2.8.4-alpine"`
...
> **start**(): `Promise`\<[`StartedNatsContainer`](/libraries/common-testing/Class.StartedNatsContainer.md)\>

#### Returns

`Promise`\<[`StartedNatsContainer`](/libraries/common-testing/Class.StartedNatsContainer.md)\>
