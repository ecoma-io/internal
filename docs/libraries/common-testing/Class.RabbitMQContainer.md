...
> **start**(): `Promise`\<[`StartedRabbitMQContainer`](/libraries/common-testing/Class.StartedRabbitMQContainer.md)\>

#### Returns

`Promise`\<[`StartedRabbitMQContainer`](/libraries/common-testing/Class.StartedRabbitMQContainer.md)\>
