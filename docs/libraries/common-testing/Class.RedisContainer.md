...
> **new RedisContainer**(`image`): `RedisContainer`
...
> **start**(): `Promise`\<[`StartedRedisContainer`](/libraries/common-testing/Class.StartedRedisContainer.md)\>

#### Returns

`Promise`\<[`StartedRedisContainer`](/libraries/common-testing/Class.StartedRedisContainer.md)\>
...
<a id="withpersistence"></a>

### withPersistence()

> **withPersistence**(`sourcePath`): `this`
