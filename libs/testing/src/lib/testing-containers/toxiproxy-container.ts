...
export class StartedToxiProxyContainer extends AbstractStartedContainer {
  ...
  constructor(startedTestContainer: StartedTestContainer) {
    ...
    this.client = new toxiProxyClient.Toxiproxy(
      `http://${this.getHost()}:${this.getMappedPort(CONTROL_PORT)}`
    );
  }
  ...
  public async createProxy(
    createProxyBody: Omit<toxiProxyClient.ICreateProxyBody, "listen">
  ): Promise<ICreatedProxy> {
